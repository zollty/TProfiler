 ...
 *   excludePackageStartsWith = com.taobao.sketch;org.apache.velocity;com.alibaba;com
 *   .taobao.forest.domain.dataobject
 * </pre>
 * <p>未例代码：
 * <pre>
 *   Properties properties = new Properties();
 *   InputStream in = getClass().getClassLoader().getResourceAsStream("profile
 *   .properties");
 *   properties.load(in);
 *
 ...
 *   try{
 *     ConfigureProperties configureProperties = new ConfigureProperties(properties,
 *     context);
 *     String logFilePath = configureProperties.getProperty("logFilePath");
 *     Assert.assertEquals(logFilePath, System.getProperty("user.home") +
 *     "/logs/tprofiler.log");
 *   }finally{
 *     in.close();
 *   }
